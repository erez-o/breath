...
#
#       The script caters to our commenting and formatting style. E.g.
#       we expect a Make target name to always begin in column 1, and
#       don't consider tab characters. You may need to adapt the script,
#       or at least the regular expressions, if your style is different.
#
#       Warning:
#       --------
#
